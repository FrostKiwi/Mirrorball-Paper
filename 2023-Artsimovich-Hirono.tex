...
\begin{multicols}{2}
	...
	\begin{figure*}
		...
		\subfloat[Scene setup]{
			\includegraphics[height=0.19\textwidth]{img/distortion_setup.jpg}
			\label{fig:ball_setup}
		}
		\hfill
		\subfloat[Captured mirror ball]{
			\includegraphics[height=0.19\textwidth]{img/distortion_ball.jpg}
			\label{fig:ball_result}
		}
		\hfill
		\subfloat[Pole-point, classical term]{
			\includegraphics[height=0.19\textwidth]{img/dist1.png}
			\label{fig:classic}
		}
		\hfill
		\subfloat[Pole-point, improved term]{
			\includegraphics[height=0.19\textwidth]{img/dist2.png}
			\label{fig:improved}
		}
	...
	\begin{figure}[H]
		\subfloat[Chrome steel ball, 100mm]{
			\includegraphics[height=0.47\linewidth]{img/ball_10cm.png}
			\label{fig:100mm}
		}
		\hfill
		\subfloat[Stainless steel ball, 50mm]{
			\includegraphics[height=0.47\linewidth]{img/ball_5cm.png}
			\label{fig:50mm}
		}
	\end{figure}
